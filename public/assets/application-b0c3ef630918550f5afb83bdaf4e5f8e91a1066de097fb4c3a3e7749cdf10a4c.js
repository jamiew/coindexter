...
(function() {
  $(function() {
    $('ul#info-menu > li').click(function() {
      var selector;
    ...
    return $('#show-all').click(function() {
      return $('ul.networks-in-categories').show();
    });
  });
...
(function() {
  $(function() {
    ...
    $('.network-option').each(function() {
      var url;
      url = $(this).data('icon');
      return $(this).css('background-image', "url('http://coindexter.io" + url + "')");
    });
    return $(window).on("scroll", function() {
      var $body_height, $curr_bottom, $remaining, $scroll_height, $scroll_top, $up_or_down;
      ...
      if ($remaining < 40) {
        ...
        return $('.action-links').css('bottom', $curr_bottom);
      } else {
        return $('.action-links').css('bottom', 30);
      }
    });
  });
...
(function() {
  ...
  $(function() {
    $('a.reply-to-comment').on('click', function() {
      $(this).hide();
      return $(this).parent().children("form").toggle();
    });
    $('a.cancel-form').on('click', function() {
    ...
    return $('.coin-option').each(function() {
      var url;
      url = $(this).data('icon');
      return $(this).css('background-image', "url('http://coindexter.io" + url + "')");
    });
...
(function() {
  $(function() {
    var $prev_scroll_top, $whitepaperCount;
    $('ul#info-menu > li').click(function() {
      var selector;
      selector = 'ul#' + $(this).attr('id');
      $('.show-all').removeClass('active-item');
    ...
    $('#show-all').click(function() {
      return $('ul.full-category-cnt').show();
    });
    $whitepaperCount = 0;
    $("#add-another-whitepaper").on("click", function() {
      var $parent_html, $parent_html_to_insert, $parent_id, $parent_id_length, $prev_parent_html, $prev_parent_html_to_insert, $repo_number, $repo_plus_one;
      $parent_id = $(this).parent().attr('id');
      $parent_id_length = $parent_id.length;
      $repo_number = parseInt($parent_id.substring($parent_id_length - 1, $parent_id_length));
      $repo_plus_one = $repo_number + 1;
      ...
      return $(this).parent().parent().next().next().find("input").val('');
    });
    $("#add-another-founder").on("click", function() {
      return $(this).before("<input type='text' name='founders[]'' id='founders'>");
    });
    $prev_scroll_top = 0;
    return $(window).on("scroll", function() {
      var $body_height, $curr_bottom, $remaining, $scroll_height, $scroll_top, $up_or_down;
      ...
      if ($remaining < 40) {
        ...
        return $('.action-links').css('bottom', 10);
      }
    });
  });
...
(function() {
  $(function() {
    return $('.search-filter-categories > li').on("click", function() {
      var ids;
      ids = $(this).attr('id');
